...
class PlaygroundSeriesS4E6Metrics(CompetitionMetrics):
    """Metric class for playground-series-s4e6 competition using accuracy score."""
    ...
    def validate_submission(self, submission: Any, ground_truth: Any) -> str:
        ...
        # Sort both by the id column (first column)

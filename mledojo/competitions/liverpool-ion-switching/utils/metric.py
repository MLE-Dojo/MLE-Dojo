...
class LiverpoolIonSwitchingMetrics(CompetitionMetrics):
    """Metric class for Liverpool Ion Switching competition using macro F1 score"""
    def __init__(self, value: str = "open_channels", higher_is_better: bool = True):
    ...
    def evaluate(self, y_true: pd.DataFrame, y_pred: pd.DataFrame) -> float:
        ...
        # Calculate macro F1 score for the specified value column

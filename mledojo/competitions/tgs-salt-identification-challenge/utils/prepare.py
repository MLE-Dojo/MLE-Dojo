...
from mledojo.competitions.utils import extract, read_csv
...
def prepare(raw: Path, public: Path, private: Path) -> None:
    ...
    new_test.sort_values(by="id").to_csv(private / "test_answer.csv", index=False)
    ...
    assert (private / "test_answer.csv").exists(), "`test_answer.csv` doesn't exist!"
    ...
    actual_new_test = read_csv(private / "test_answer.csv")

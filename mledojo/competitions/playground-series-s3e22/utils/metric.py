...
class PlaygroundSeriesS3e22Metrics(CompetitionMetrics):
    """Metric class for Synthetically-Generated Datasets competition using micro-averaged F1-Score"""
    ...
    def evaluate(self, y_true: pd.DataFrame, y_pred: pd.DataFrame) -> float:
        ...
        return f1_score(y_true[self.value], y_pred[self.value], average="micro")
    ...
    def validate_submission(self, submission: Any, ground_truth: Any) -> str:
        ...
        if (submission[submission.columns[0]].values != ground_truth[ground_truth.columns[0]].values).any():
            raise InvalidSubmissionError("The id column values do not match between submission and ground truth. Please ensure the id values are identical.")

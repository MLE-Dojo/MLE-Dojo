...
class MovieReviewSentimentAnalysisKernelsOnlyMetrics(CompetitionMetrics):
    """Metric class for Movie Review Sentiment Analysis Kernels Only competition using classification accuracy"""
    ...
    def evaluate(self, y_true: pd.DataFrame, y_pred: pd.DataFrame) -> float:
        # Convert the id column (assumed to be the first column: 'PhraseId') to string type
        y_true[y_true.columns[0]] = y_true[y_true.columns[0]].astype(str)
        y_pred[y_pred.columns[0]] = y_pred[y_pred.columns[0]].astype(str)
        
        # Sort both dataframes by the first column 'PhraseId'
    ...
    def validate_submission(self, submission: Any, ground_truth: Any) -> str:
        ...
        # Sort submission and ground truth by the id column 'PhraseId'

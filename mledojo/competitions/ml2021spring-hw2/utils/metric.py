...
class Ml2021springHw2Metrics(CompetitionMetrics):
    """Metric class for ml2021spring-hw2 competition using categorization accuracy for framewise phoneme classification of TIMIT dataset"""
    def __init__(self, value: str = "ClassId", higher_is_better: bool = True):
    ...
    def evaluate(self, y_true: pd.DataFrame, y_pred: pd.DataFrame) -> float:
        ...
        # Sort by the id column (first column) to align ground truth and predictions

...
class PlaygroundSeriesS3e7Metrics(CompetitionMetrics):
    """Metric class for Playground Series S3E7 competition using ROC AUC."""
    def __init__(self, value: str = "booking_status", higher_is_better: bool = True):
    ...
    def validate_submission(self, submission: Any, ground_truth: Any) -> str:
        ...
        expected_columns = set(ground_truth.columns)
        submission_columns = set(submission.columns)

        missing_cols = expected_columns - submission_columns
        extra_cols = submission_columns - expected_columns

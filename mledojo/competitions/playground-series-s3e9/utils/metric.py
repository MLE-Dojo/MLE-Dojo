...
class PlaygroundSeriesS3e9Metrics(CompetitionMetrics):
    """Metric class for Playground Series S3E9 competition using Root Mean Squared Error (RMSE)."""
    def __init__(self, value: str = "Strength", higher_is_better: bool = False):

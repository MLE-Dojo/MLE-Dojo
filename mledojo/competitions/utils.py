# Adapted from https://github.com/openai/mle-bench/blob/main/mlebench/utils.py
...
def download_competition_data(comp_name, data_dir):
    """
    Downloads Kaggle competition datasets using kaggle CLI to specified folders,
    extracts the zip file and removes the original zip
    """
    ...
    def download_dataset(comp_name):
        ...
        # Change to competition directory
        os.chdir(comp_dir)
        ...
        try:
            ...
            print(f"Error downloading competition {comp_name}: {str(e)}")
        except Exception as e:

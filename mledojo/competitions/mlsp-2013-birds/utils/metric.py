...
class Mlsp2013BirdsMetrics(CompetitionMetrics):
    """Metric class for MLSP 2013 Birds competition using AUC"""
    ...
    def evaluate(self, y_true: pd.DataFrame, y_pred: pd.DataFrame) -> float:
        ...
        for col in y_true.columns:
            if col == y_true.columns[0]:  # Skip ID column
                continue
            fpr, tpr, _ = metrics.roc_curve(y_true[col], y_pred[col], pos_label=1)

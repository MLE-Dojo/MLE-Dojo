...
class PlaygroundSeriesS3E1Metrics(CompetitionMetrics):
    def __init__(self, value: str = "MedHouseVal", higher_is_better: bool = False):
    ...
    def validate_submission(self, submission: Any, ground_truth: Any) -> str:
        ...
        if not (submission[submission.columns[0]].values == ground_truth[ground_truth.columns[0]].values).all():
            raise InvalidSubmissionError("The id values in submission do not match those in ground truth. Please ensure the id columns are identical.")

...
class ForestCoverTypeKernelsOnlyMetrics(CompetitionMetrics):
    """Metric class for forest-cover-type-kernels-only competition using multi-class classification accuracy"""

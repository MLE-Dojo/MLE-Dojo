...
class PlaygroundSeriesS3E14Metrics(CompetitionMetrics):
    """Metric class for playground-series-s3e14 competition using Mean Absolute Error (MAE)"""
    def __init__(self, value: str = "yield", higher_is_better: bool = False):
        super().__init__(higher_is_better)
        self.value = value

    def evaluate(self, y_true: pd.DataFrame, y_pred: pd.DataFrame) -> float:
        # Convert id columns to string type for proper sorting

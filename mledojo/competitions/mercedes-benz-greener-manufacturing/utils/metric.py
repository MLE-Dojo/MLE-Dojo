...
class MercedesBenzGreenerManufacturingMetrics(CompetitionMetrics):
    """Metric class for Mercedes-Benz Greener Manufacturing competition using R² score"""
    def __init__(self, value: str = "y", higher_is_better: bool = True):
        super().__init__(higher_is_better)
        self.value = value

    def evaluate(self, y_true: pd.DataFrame, y_pred: pd.DataFrame) -> float:
        # Ensure the ID columns are treated as strings for proper sorting

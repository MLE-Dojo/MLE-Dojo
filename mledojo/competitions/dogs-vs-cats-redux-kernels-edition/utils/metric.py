...
class DogsVsCatsReduxKernelsEditionMetrics(CompetitionMetrics):
    """Metric class for Dogs vs Cats Redux: Kernels Edition competition using Log Loss"""

    def __init__(self, value: str = "label", higher_is_better: bool = False):
    ...
    def evaluate(self, y_true: pd.DataFrame, y_pred: pd.DataFrame) -> float:
        ...
        y_true = y_true[self.value].values
        y_pred = y_pred[self.value].values
        epsilon = 1e-15

...
class PlaygroundSeriesS3e5Metrics(CompetitionMetrics):
    """Metric class for playground-series-s3e5 competition using Quadratic Weighted Kappa"""
    def __init__(self, value: str = "quality", higher_is_better: bool = True):

...
class TheIcml2013WhaleChallengeRightWhaleReduxMetrics(CompetitionMetrics):
    """Metric class for The ICML 2013 Whale Challenge Right Whale Redux competition using AUC"""

    def __init__(self, value: str = "probability", higher_is_better: bool = True):
    ...
    def evaluate(self, y_true: pd.DataFrame, y_pred: pd.DataFrame) -> float:
        ...
        fpr, tpr, _ = metrics.roc_curve(y_true[self.value], y_pred[self.value], pos_label=1)

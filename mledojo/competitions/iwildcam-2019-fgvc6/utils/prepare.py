...
from mledojo.competitions.utils import extract, get_logger, read_csv
...
def prepare(raw: Path, public: Path, private: Path):
    ...
    # Write CSVs
    # only keep id and category_id, rename to Id and Category
    answers = answers[["id", "category_id"]]
    answers.rename(columns={"id": "Id", "category_id": "Category"}, inplace=True)

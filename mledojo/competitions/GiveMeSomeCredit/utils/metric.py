...
class GiveMeSomeCreditMetrics(CompetitionMetrics):
    """Metric class for GiveMeSomeCredit competition using AUC as evaluation metric."""
    ...
    def validate_submission(self, submission: Any, ground_truth: Any) -> str:
        ...
        # Check if the first column values are identical

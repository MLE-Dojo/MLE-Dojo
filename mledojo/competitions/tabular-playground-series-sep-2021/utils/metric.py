...
class TabularPlaygroundSeriesSep2021Metrics(CompetitionMetrics):
    """Metric class for tabular-playground-series-sep-2021 competition using Area under the ROC Curve"""
    
    def __init__(self, value: str = "claim", higher_is_better: bool = True):
    ...
    def evaluate(self, y_true: pd.DataFrame, y_pred: pd.DataFrame) -> float:
        ...
        # Calculate and return the area under the ROC curve
    ...
    def validate_submission(self, submission: Any, ground_truth: Any) -> str:
        ...
        if (submission[submission.columns[0]].values != ground_truth[ground_truth.columns[0]].values).any():
            raise InvalidSubmissionError("The id values do not match between submission and ground truth. Please ensure the first column values are identical.")

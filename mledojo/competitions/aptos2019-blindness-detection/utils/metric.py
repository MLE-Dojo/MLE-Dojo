...
class Aptos2019BlindnessDetectionMetrics(CompetitionMetrics):
    """Metric class for APTOS 2019 Blindness Detection competition using Quadratic Weighted Kappa"""
    def __init__(self, value: str = "diagnosis", higher_is_better: bool = True):

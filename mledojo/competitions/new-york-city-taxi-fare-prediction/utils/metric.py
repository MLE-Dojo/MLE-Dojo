...
class NewYorkCityTaxiFarePredictionMetrics(CompetitionMetrics):
    """Metric class for New York City Taxi Fare Prediction competition using RMSE"""

    def __init__(self, value: str = "fare_amount", higher_is_better: bool = False):
    ...
    def evaluate(self, y_true: pd.DataFrame, y_pred: pd.DataFrame) -> float:
        ...
        return mean_squared_error(y_true[self.value], y_pred[self.value])

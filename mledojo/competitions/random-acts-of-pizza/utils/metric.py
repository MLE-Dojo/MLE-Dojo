...
class RandomActsOfPizzaMetrics(CompetitionMetrics):
    """Metric class for Random Acts of Pizza competition using AUC-ROC"""

    def __init__(self, value: str = "requester_received_pizza", higher_is_better: bool = True):
